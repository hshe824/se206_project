...
public class MarqueeControls extends JPanel {
	...
	public MarqueeControls(MediaPlayer mediaPlayer) {
		this.mediaPlayer = mediaPlayer;
		createUI();
	}

	/**
	 * Creates the gui in three steps
	 */
	...
	/**
	 * Creates the controls, ie the sliders and sets them up
	 */
	...
	/**
	 * Lays out the controls accordingly using boxlayout
	 */
	...
	/**
	 * Registers all the listeners required
	 */
